...
export default function HomeCta() {
  const stats = [
    ...
    { value: '500+', label: 'Unique Designs', icon: Zap },
    { value: 'Lifetime', label: 'Warranty', icon: Sparkles },
  ];
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                ...
                jewelry as unique as you are, with free personalization on every order.
              </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Personal Engraving</h3>
              <p className="text-sm text-muted-foreground">
                Free custom engraving to make each piece uniquely yours
              </p>
            </div>
          </div>
        </div>
