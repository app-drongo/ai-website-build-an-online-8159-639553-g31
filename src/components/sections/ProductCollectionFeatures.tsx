...
import { Gem, Heart, Sparkles, Crown, Star, Gift, Palette, Award, ShieldCheck } from 'lucide-react';

export default function ProductCollectionFeatures() {
  const features = [
    {
      icon: Gem,
    ...
    },
    {
      ...
      description:
        'Work directly with our master jewelers to create bespoke pieces tailored to your vision and preferences.',
      badge: 'Bespoke',
    },
    {
      icon: Gift,
    ...
    {
      icon: Award,
      title: 'Award-Winning Artisans',
      description:
        'Our jewelry makers have been recognized internationally for their exceptional skill and innovative designs.',
      badge: 'Excellence',
    },
    {
      icon: ShieldCheck,
      ...
      description:
        'Every piece comes with a certificate of authenticity and our promise of genuine materials and craftsmanship.',
      badge: 'Guarantee',
    },
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Discover the artistry, quality, and passion that goes into every handcrafted piece in
